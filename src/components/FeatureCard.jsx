...
export default function FeatureCard({ icon: Icon, title, description, to }) {
  ...
  return (
    <Wrapper to={to} className="card card-hover group flex h-full flex-col p-6 sm:p-7">
      <span className="inline-flex size-11 items-center justify-center rounded-xl bg-surface-2 text-gold transition-colors group-hover:bg-gold group-hover:text-ink">
